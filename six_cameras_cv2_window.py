...
#endpoint doesnt matter for get request: csrf token is randomly generated by django for all endpoints.
csrftoken = get_response.cookies['csrftoken']
"""

def send_image_frame(image_data, headers):
    files = {'image': image_data}
    response = requests.post("http://127.0.0.1:8000/rgb", files=files, headers=headers)
...
def rgb_callback(image, data_dict):
    ...
    send_image_frame(image_frame, headers) 
